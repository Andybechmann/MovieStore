...
namespace MovieStoreDAL
{
    public class MovieStoreDbInitializer : DropCreateDatabaseIfModelChanges<MovieStoreDbContext>
    {
        protected override void Seed(MovieStoreDbContext context)
        {
            ...
            Movie movie = new Movie { Title = "title",Year=DateTime.Now, ImageUrl = "http://ia.media-imdb.com/images/M/MV5BMTkwNzAwNDA4N15BMl5BanBnXkFtZTgwMTA2MDcwNzE@._V1__SX1857_SY903_.jpg", TrailerUrl = "", Price = 10 };
